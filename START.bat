@echo off
REM Cursor Simple - Quick Start for Windows
REM Just double-click this file to run!

REM Change to script directory
cd /d "%~dp0"

title Cursor Simple - Quick Start
...
if exist "%TEMP_DIR%\python-installer.exe" (
    ...
    echo    5. Close this window and run START.bat again
    echo.
    echo ================================================================
    echo.
    pause
...
%PYTHON_CMD% -c "import colorama, requests" >nul 2>&1
if %errorlevel% neq 0 (
    echo First time setup detected...
    echo Installing dependencies...
    echo.
    
    REM Install with flags to suppress warnings about Scripts not in PATH
